      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-ofa-ink via-ofa-charcoal to-ofa-wisdom relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 max-w-md">
            <p className="text-ofa-cloud/90 mb-4 italic">
              "I finally feel like I'm driving my life instead of just reacting to it. This is the tool I wish I had years ago."
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-ofa-cloud/50 text-xs">Founder, early user</p>
              </div>
            </div>
          </div>
        </div>
